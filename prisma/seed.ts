...
const PERMISSIONS = [
  ...
  { code: 'CREATE_STAFF_DAY_OFF', name: 'Tạo ngày nghỉ cho nhân viên' },
  { code: 'REQUEST_OWN_DAY_OFF', name: 'Tự đăng ký ngày nghỉ' },
...
const STAFF_PERMISSIONS = [
  ...
  'CREATE_PAYMENT', 'UPDATE_PAYMENT', 'VIEW_PAYMENT', 'VIEW_REVIEW',
  'CREATE_CONVERSATION', 'VIEW_CONVERSATION',
  'CREATE_MESSAGE', 'VIEW_MESSAGE',
  'VIEW_STAFF_SCHEDULE', 'VIEW_STAFF_DAY_OFF', 'REQUEST_OWN_DAY_OFF',
